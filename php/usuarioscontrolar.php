...
<div class="content">
			...
			<table>
<tr><th>Id</th><th>Nome</th><th>Email</th><th>Senha</th><th>Acesso</th><th>Status</th><th colspan="4">Ações</td></tr>
...
<td><a href='usuariobloquear.php?id=" . $row["Id"] . "&status=" . $row["Status"] ."'><img src='../imagens/recusado.png' alt='Denuncia recusada' height='50px'></a></td><td><a href='usuarioeditarform.php?id=" . $row["Id"] . "'><img src='../imagens/editar.png' alt='Editar Usuário'></a></td><td><a href='usuarioexcluir.php?id=" . $row["Id"] . "'><img src='../imagens/excluir.png' alt='Excluir Usuário'></a></td></tr>";
	  }
	?>
...
<div class="pagination">
	...
	?>   
            ...
            <a href="admincadastrar.php"><img src="../imagens/incluir.png" alt="Incluir Usuário"></a>
    </div>
