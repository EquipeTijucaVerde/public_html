...
$texto = "ATENÇÃO COMLURB<br> Um de nossos usuários pode ter um alerta de um possível LIXO DESPEJADO DE FORMA IRREGULAR, pedimos que enviem uma de suas unidades para o local imediatamente e acabem com a imundice, dando um fim nesse descarte incorreto de lixo de uma vez por todas<br><br><br> Local da Denuncia: '"  . $campolocaldenuncia . "' <br><br>Descrição da Denúncia: '" . $campodescricao . "'<br><br><br>Atensiosamente, Equipe Tijuca Verde.<br>";


//Chamada da função no do código
enviaremail($camponome, $campoemail, 'Lixo irregular', $texto);
